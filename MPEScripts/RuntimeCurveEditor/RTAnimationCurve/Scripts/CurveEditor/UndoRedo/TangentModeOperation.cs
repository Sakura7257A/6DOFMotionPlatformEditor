    ...
    public class TangentModeOperation : Operation
    {
        ...
        void SwitchContextMenu() {
            ...
            if (contextMenu.clampedAuto) {
                ...
                } else if(contextMenu.bothTangents.free) {
                    curveLines.Free(TangentPart.Both);
                } else if (contextMenu.leftTangent.free) {
                    curveLines.Free(TangentPart.Left);
                } else if (contextMenu.rightTangent.free) {
                    curveLines.Free(TangentPart.Right);
                }
            }
