...
namespace RuntimeCurveEditor
{
    ...
    public class CurveForm
    {
        ...
        public static float X_MAXIM;//默认横轴参数
        public static float X_MIN = 0.0f;
        public static float Y_MAXIM = 1.7f;
        public static float Y_MIN = -Y_MAXIM;
        public static Rect defaultRect = Rect.MinMaxRect(X_MIN, Y_MIN, X_MAXIM, Y_MAXIM);
        ...
        public bool isVisible = true; // ✨ 新增：控制当前曲线是否渲染及可交互
