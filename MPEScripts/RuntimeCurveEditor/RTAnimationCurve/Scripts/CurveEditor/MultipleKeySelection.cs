    ...
    public class MultipleKeySelection : MonoBehaviour
    {
        ...
        void DrawSelection() {
            if (MultipleKeySelectionOn) {
                ...
                {
                    currentCamera.ScreenToWorldPoint(new Vector3(startPoint.x, startPoint.y, 0)),
                    currentCamera.ScreenToWorldPoint(new Vector3(startPoint.x, endPoint.y, 0)),
                    currentCamera.ScreenToWorldPoint(new Vector3(endPoint.x, endPoint.y, 0)),
                    currentCamera.ScreenToWorldPoint(new Vector3(endPoint.x, startPoint.y, 0)),
                    currentCamera.ScreenToWorldPoint(new Vector3(startPoint.x, startPoint.y, 0))
                };
                ...
                Graphics.RenderMesh(Curves.renderParams, meshLines, 0, matrix4X4_Z_POS);
                ...
                Graphics.RenderMesh(Curves.renderParams, meshQuad, 0, matrix4X4_Z_POS);
                triggerUpdate = true;
            }
            ...
            if (selectedKnots.Count > 1) {
                if (triggerUpdate)
                {
                    ...
                    List<Vector3> verticesQuads = new List<Vector3>
                    {
                        currentCamera.ScreenToWorldPoint(new Vector3(leftPadBottom.x, leftPadBottom.y, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(leftPadBottom.x, rightPadTop.y, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(rightPadTop.x, rightPadTop.y, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(rightPadTop.x, leftPadBottom.y, 0))
                    };
                    ...
                    {
                        currentCamera.ScreenToWorldPoint(new Vector3(leftPadBottom.x + HALF_PAD.x, resizeLineBottom, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(rightPadTop.x - HALF_PAD.x, resizeLineBottom, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(leftPadBottom.x + HALF_PAD.x, resizeLineTop, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(rightPadTop.x - HALF_PAD.x, resizeLineTop, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(resizeLineLeft, leftPadBottom.y + HALF_PAD.y, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(resizeLineLeft, rightPadTop.y - HALF_PAD.y, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(resizeLineRight, leftPadBottom.y + HALF_PAD.y, 0)),
                        currentCamera.ScreenToWorldPoint(new Vector3(resizeLineRight, rightPadTop.y - HALF_PAD.y, 0))
                    };
                    meshLinesSelectionResize.SetVertices(verticesLinesSelectionResize);
                }

                Graphics.RenderMesh(Curves.renderParams, meshQuadSelection, 0, matrix4X4_Z_POS);
                Graphics.RenderMesh(Curves.renderParams, meshLinesSelectionResize, 0, matrix4X4_Z_POS);
            }
        }
