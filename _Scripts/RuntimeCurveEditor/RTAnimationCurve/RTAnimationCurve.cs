    ...
    public class RTAnimationCurve : MonoBehaviour
    {
        ...
        public bool Add(ref AnimationCurve curve) {
            ...
            if (!curveLines.CurveShown(curve)) {
                ...
                curveLines.AddCurveForm(curve, null,null);
            }
            return true;
        }

        public void HidenCurve(ref AnimationCurve curve)
        {
            curveLines.CurveShown(curve);
        }
        ...
        /// </summary>
        public bool Add(ref AnimationCurve curve1, ref AnimationCurve curve2, ref AnimationCurve curve3) {
            if (curveLines == null) {
                return false;
            }
            if (!curveLines.CurvesShown(curve1, curve2)) {
                ...
                curveLines.AddCurveForm(curve1, curve2, curve3);
            }
            return true;
        }
